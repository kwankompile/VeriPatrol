...
def backend_enabled_config(minimal_config) -> Config:
    """Backend-enabled config with deterministic camera credentials."""
    minimal_config.backend_enabled = True
    minimal_config.backend_base_url = "http://127.0.0.1:8000/api"
    minimal_config.camera_email = "camera@example.com"
    minimal_config.camera_password = "secret"
    minimal_config.rtsp_url = "rtsp://camera.local/stream"
