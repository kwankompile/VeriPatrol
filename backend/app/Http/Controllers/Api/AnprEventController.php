...
class AnprEventController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            if ($camera !== null) {
                $rules['camera_id'] = ['sometimes', 'nullable', 'uuid', 'exists:cameras,id'];
            } else {
                $rules['camera_id'] = ['required', 'exists:cameras,id'];
            }
            ...
            if ($camera !== null) {
                $forbidden = AnprCameraPrincipal::forbiddenOnCameraIdMismatch(
                    $camera,
                    $validated['camera_id'] ?? null,
                );
