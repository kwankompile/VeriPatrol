...
use App\Models\User;
use App\Services\Auth\AuthAccountRecoveryService;
...
class AuthController extends Controller
{
    public function __construct(
        ...
        private readonly AuthAccountRecoveryService $authAccountRecoveryService,
    ) {}
     ...
     */
    /**
     * Admin-only: reset a user's two-factor authentication and revoke all sessions.
     */
    public function resetTwoFactor(Request $request, string $user): JsonResponse
    {
        ...
        $result = $this->authAccountRecoveryService->resetTwoFactorForUser($target, $admin, $request);
