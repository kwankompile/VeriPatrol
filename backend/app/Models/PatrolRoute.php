...
/**
 * @deprecated Compatibility storage for legacy patrol sessions only.
 *             Canonical GPS evidence is location_logs (see PatrolMovementService).
 *             Do not dual-write new samples here from the SPA.
 */
