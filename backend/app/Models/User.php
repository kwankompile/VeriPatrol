...
{
    public const PRINCIPAL_TYPE = 'user';
    ...
    protected function casts(): array
    {
        return [
            ...
            'last_security_changed_at' => 'datetime',
    ...
    public function profileChangeTokens(): HasMany
    {
        return $this->hasMany(ProfileChangeToken::class);
    }
