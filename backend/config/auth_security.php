...
return [
    ...
    'camera_token_ttl_minutes' => (int) env('AUTH_CAMERA_TOKEN_TTL', env('JWT_TTL', 60)),
    'camera_login_max_attempts' => (int) env('AUTH_CAMERA_LOGIN_MAX_ATTEMPTS', 5),
    'camera_login_lock_minutes' => (int) env('AUTH_CAMERA_LOGIN_LOCK_MINUTES', 15),
