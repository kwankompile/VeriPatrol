...
class AuthAuditLogTest extends TestCase
{
    ...
    public function test_audit_metadata_redacts_case_insensitive_sensitive_value_prefixes(): void
    {
        $auditService = app(AuthAuditService::class);
        ...
        $log = $auditService->record(
            ...
            metadata: [
                'note' => 'retry',
                'lower_bearer' => 'bearer secret.jwt.token',
                'upper_bearer' => 'BEARER secret.jwt.token',
                'mixed_otpauth' => 'OTPAuth://totp/Example:user?secret=ABC',
            ],
        );
