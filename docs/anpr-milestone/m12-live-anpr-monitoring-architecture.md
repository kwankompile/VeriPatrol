...
- Targeted documentation updates in `anpr`, `backend`, and `frontend`
...
- Vehicle resource fields preserved; **M13** vehicle auto-linking is implemented in Laravel (`AnprVehicleLinkingTest`).
