...
**Related planning document:** [`login-module.md`](../../../docs/login-module.md)  
...
- Gap analysis and future milestone order aligned with [`login-module.md`](../../../docs/login-module.md).
...
| Blockchain records | `GET/POST blockchain-records/*` | `admin` middleware; **Admin only** |
...
| --- | --- |
| Guard | `guard` only |
| Security Operator | `patrolHome` + operator monitoring subset (patrol, ANPR) |
...
Recommended implementation order (aligned with [`login-module.md`](../../../docs/login-module.md) and this audit):
...
- [x] `backend/docs/login/m0-auth-baseline-and-current-audit.md` exists.
...
- [`login-module.md`](../../../docs/login-module.md) — full target architecture and extended milestone detail
- [`backend/documentation.md`](../../documentation.md) — Section 6 Authentication & authorization
- [`frontend/documentation.md`](../../../frontend/documentation.md) — Section 6 Authentication & Authorization
