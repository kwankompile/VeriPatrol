...
| `frontend/src/api/api.js` | `credentials: 'include'` |
...
- [`login-module.md`](../../../docs/login-module.md)
- [`backend/documentation.md`](../../documentation.md) — Section 6
- [`frontend/documentation.md`](../../../frontend/documentation.md) — Section 6
