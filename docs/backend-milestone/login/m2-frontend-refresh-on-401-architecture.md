...
**Milestone:** M2  
**Status:** Complete  
**Implementation repository:** `frontend/` (frontend-only; backend M1 contract unchanged)  
...
| `frontend/documentation.md` | API client / auth flow updates |
| `backend/documentation.md` | Cross-reference to M2 doc |
...
- [x] M2 documentation exists under `backend/docs/login/`
