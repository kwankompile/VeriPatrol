...
**Milestone:** M3  
**Status:** Complete  
**Implementation repository:** `frontend/` (primary); `backend/` (verification tests only)  
**Planning reference:** [`login-module.md`](../../../docs/login-module.md)  
...
| File                                                             | Change                            |
| ---------------------------------------------------------------- | --------------------------------- |
| `frontend/src/pwa/syncService.test.js`                  | **New** — M3 Vitest coverage      |
| `backend/tests/Feature/PatrolTokenExpiryTest.php`     | **New** — M3 backend verification |
| `backend/docs/login/m3-patrol-token-expiry-safety.md` | **New** — this document           |
| `frontend/documentation.md`                             | M3 cross-link on PWA sync         |
| `backend/documentation.md`                            | M3 cross-link + test table entry  |
